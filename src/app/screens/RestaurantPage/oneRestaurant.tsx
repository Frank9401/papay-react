...
export function OneRestaurant(props: any) {
  ...
  useEffect(() => {
    ...
    restaurantService
      ...
      .then((data: Restaurant) => setChosenRestaurant(data))
          ...
          >
            ...
            <Stack className="dish_wrapper">
              {targetProducts.map((product: Product) => {
                ...
                const image_path = `${serviceApi}/${updatedData}`;
                const size_volume =
      ...
      <Container className="member_reviews">
        ...
        >
          <Box
            ...
            sx={{
              backgroundImage: `url(${serviceApi}/${chosenRestaurant?.mb_image.replace(
                /\\/g,
                "/"
              )})`,
            }}
          >
            <div className={"about_left_desc"}>
              ...
              <p>{chosenRestaurant?.mb_description} Eng mazzali oshxona</p>
            </div>
          </Box>

...
import { BorderColor, Favorite, LocationOnRounded, Visibility } from "@mui/icons-material";
import { AspectRatio, 
    Card,CardOverflow,CssVarsProvider,
     IconButton,
     Link,
...
export function BestRestaurants(){
    return(
        <div className="best_restaurant_frame">
            ...
            style={{position: "absolute", left: "6%", transform: "rotate(90degree)"}}
            />
            <Container sx={{paddingTop: "153px"}} >
                ...
                >
                    ...
                    style={{
                        ...
                        <Typography level="body2" sx={{ mt: 2.5, mb: 2}}>
                            <Link href=""
